...
void
autoObject::incref() {
	pthread_mutex_lock(PTHREAD_CAST&this->refcountLock);
    ++this->refcount;
	pthread_mutex_unlock(PTHREAD_CAST&this->refcountLock);
}
...
autoObject::autoObject() {
	...
	rc = pthread_mutex_init(PTHREAD_CAST&this->refcountLock, NULL);
...
autoObject::~autoObject() {
	...
	rc = pthread_mutex_destroy(PTHREAD_CAST&this->refcountLock);
